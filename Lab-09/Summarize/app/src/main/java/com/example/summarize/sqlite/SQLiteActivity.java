...
public class SQLiteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new JobAdapter(SQLiteActivity.this, R.layout.activity_job, jobArrayList);
    ...
    public void DialogAddNewJob() {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jobName.equals("")) {
                    Toast.makeText(SQLiteActivity.this, "Vui lòng nhập tên công việc !", Toast.LENGTH_SHORT).show();
                } else {
                    db.QueryData("Insert into Job values(null, '" + jobName + "')");
                    Toast.makeText(SQLiteActivity.this, "Thêm công việc mới thành công!", Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                    GetDataJob();
                }
            }
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View View) {
                ...
                if (newName.equals("")) {
                    ...
                    Toast.makeText(SQLiteActivity.this, "Cập nhật công việc thành công!", Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                    GetDataJob();
                }
            }
    ...
    public void DialogDeleteJob(String name, int id) {
        ...
        dialogDelete.setPositiveButton("Có", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(SQLiteActivity.this, "Xóa công việc thành công " + name + "!", Toast.LENGTH_SHORT).show();
                GetDataJob();
            }
        });
